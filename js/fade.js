...
Banner.prototype={
    ...
    bind:function(){
        ...
        for(var i=0; i<this.data.length; i++){
            var reg=/big/;
            if(reg.test(this.data[i].imgSrc)){
                strDiv+='<div class="big_banner"><img realImg="'+this.data[i].imgSrc+'" alt=""/></div>';
            }else{
                strDiv+='<div class="little_banner"><img realImg="'+this.data[i].imgSrc+'" alt=""/></div>';
            }
